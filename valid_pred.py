...
from util.points_io import write_pred_dataframe,plot_heatmaps,save_heatmaps

print('--Parsing Config File')
args = sys.argv
assert len(args)==2, "need please use python train.py <config name>"
config_name = args[1]


# params = process_config(os.path.join(dirname, config_name))
params = process_config(config_name)
##reading data###
